...
internal sealed class Version080Overlay
{
    ...
    {
        // Register after the 0.7.6 layout controller so this is the final visible label.
    ...
    private void OnRenderedActiveMenu(object? sender, RenderedActiveMenuEventArgs e)
    {
        ...
        e.SpriteBatch.DrawString(Game1.smallFont, "COMPANY 0.8.0", new Vector2(menu.xPositionOnScreen + 27, menu.yPositionOnScreen + 67), light);
        ...
        e.SpriteBatch.DrawString(Game1.smallFont, "Agricultural Company 0.8.0 · Production UI Rebuild", new Vector2(x + 18, noteY + 14), accent);
    }
}
