...
internal sealed class Version080Overlay
{
    ...
    private void OnRenderedActiveMenu(object? sender, RenderedActiveMenuEventArgs e)
    {
        ...
        e.SpriteBatch.DrawString(Game1.smallFont, "COMPANY 0.8.1", new Vector2(menu.xPositionOnScreen + 27, menu.yPositionOnScreen + 67), light);
        ...
        e.SpriteBatch.DrawString(Game1.smallFont, "Agricultural Company 0.8.1 · Production UI Route Fix", new Vector2(x + 18, noteY + 14), accent);
    }
}
